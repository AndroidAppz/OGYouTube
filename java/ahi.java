...
extends MenuInflater {
    ...
    static {
        Class[] arrclass;
        a = arrclass = new Class[]{Context.class};
        e = arrclass;
    }
    ...
    public ahi(Context context) {
        super(context);
        this.c = context;
        this.f = this.b = new Object[]{context};
    }

    /*
     * Exception decompiling
     */
    private final void a(XmlPullParser var1, AttributeSet var2_3, Menu var3_2) {
    ...
    final Object a(Object object) {
        ...
        while (!(object2 instanceof Activity) && object2 instanceof ContextWrapper) {
     ...
     * Exception decompiling
     */
    public final void inflate(int var1, Menu var2_2) {
        // This method has failed to decompile.  When submitting a bug report, please provide this stack trace, and (if you hold appropriate legal rights) the relevant class file.
