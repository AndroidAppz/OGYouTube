...
public class avc {
    ...
    public static boolean b = Log.isLoggable((String)"Volley", (int)2);

    public static /* varargs */ void a(String string, Object ... arrobject) {
        if (b) {
            avc.d(string, arrobject);
        }
    }
    ...
    public static /* varargs */ void c(String string, Object ... arrobject) {
        Log.e((String)a, (String)avc.d(string, arrobject));
    }

    /*
     * Exception decompiling
     */
    public static /* varargs */ String d(String var0_1, Object ... var1) {
